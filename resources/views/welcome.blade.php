...
<nav class="bg-white border-gray-200 dark:bg-gray-900"> 
    ...
    <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="https://smkpesat.sch.id/wp-content/uploads/2024/09/LOGO-SMK-PESAT-IT-XPRO-DENGAN-STROKE.png" class="h-10" alt="Flowbite Logo" />
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">200,000+ aduan yang sudah pernah kami layani  kami berkomitmen untuk terus meningkatkan layanan kami. Mari bersama-sama membangun solusi dan mencapai perubahan positif!"</p>
